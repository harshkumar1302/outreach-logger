...
const blank=()=>({name:'',platform:'Instagram',handle:'',niche:'',audience:'',website:'',industry:'',poc:'',designation:'',stage:'New',country:{name:'India',flag:'🇮🇳',code:'+91'},phone:'',email:'',connected:'Cold DM (Instagram)',reachedBy:'',date:today(),response:'Not Contacted',responseNotes:'',follow:'No',followDate:'',followNotes:'',nextAction:'',remarks:''});
...
const countries=[['India','🇮🇳','+91'],['United States','🇺🇸','+1'],['United Kingdom','🇬🇧','+44'],['Australia','🇦🇺','+61'],['Singapore','🇸🇬','+65'],['Canada','🇨🇦','+1'],['United Arab Emirates','🇦🇪','+971'],['Germany','🇩🇪','+49'],['France','🇫🇷','+33'],['Other','🌐','+']].map(([name,flag,code])=>({name,flag,code}));
